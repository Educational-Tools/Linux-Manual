...
Παράδειγμα σύνταξης:
    ...
    [![](synaptic.png)](https://el.ltsp.org/mint/software/#χρήση-του-synaptic)
...
Μπορείτε να προσθέσετε πράσινο ![✔][✔] ή και κόκκινο ![✖][✖] σύμβολο ως εικόνα,
μέσα σε κείμενο ή πίνακα.

!!! warning "Προσοχή"
    Στο τέλος του αρχείου, θα πρέπει να προσθέσετε τα σχετικά paths των
    αντίστοιχων εικόνων, όπως τα ακόλουθα παραδείγματα:
    ```text
...
Παράδειγμα σύνταξης:
    ...
    [Εγκατάσταση Λογισμικού](../../mint/software.md)
...
!!! info "Πληροφορία"
    ...
    Παράδειγμα σύνταξης:
        ...
        [Εγκατάσταση Λογισμικού - Χρήση του Synaptic](../../mint/software.md#χρήση-του-synaptic)
...
!!! tip "Χρήσιμο"
    ...
    Έτσι πλέον η αναφορά στην συγκεκριμένο αρχείο/ενότητα γίνεται ως εξής:
        ...
        [Εγκατάσταση Λογισμικού - Χρήση του Synaptic](../../mint/software.md#use-of-synaptic)
