...
ή για εξυπηρετητή ΣΕΠΕΗΥ που χρησιμοποιεί LTSP, θα πρέπει καταρχάς να εγκατασταθεί το
...
- Το Linux Mint περιλαμβάνει έναν ηλεκτρονικό οδηγό που είναι διαθέσιμος από
  το ***Έναρξη*** ▸ ***Βοήθεια***.
- Ή υπάρχει διαθέσιμος online μέσω του συνδέσμου [Οδηγός του
  Linux Mint](https://linuxmint.com/documentation.php)
<hr/>
[Επόμενη Σελίδα >](download.md)
